...
CREATE PROCEDURE USP_DETALLE_VENTAS
@X VARCHAR(50)
AS
...
CREATE  TRIGGER TR_NO_STOCK_PRODUCTOS
...
CREATE PROC USP_DETALLE_VENTABOLETA
@CODIGO INT
AS
...
CREATE PROC USP_FILTRAR_VENTA_FECHAS
@FECHAINI DATE = NULL,
@FECHAFIN DATE = NULL
AS
